            ...
            <div className="container mx-auto px-6 md:px-12 max-w-[1600px] relative z-10">
                ...
                >
                    ...
                    <div className="text-center mb-16">
                        <h3 className="text-5xl md:text-6xl font-bold text-white skill-title-glow tracking-tight">
                            Skills
                        </h3>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-20">
                        {categories.map((category) => (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className={`px-8 py-3 rounded-full text-sm font-semibold transition-all duration-300 border focus:outline-none ${activeTab === category.id
